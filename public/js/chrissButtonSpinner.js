(function () {
    ...
    function shouldHandleLink(link, event) {
        ...
        // Skip hash-anchors that point to the current page (e.g., /#services, /#products)
        // These should scroll to the element, not cause a page reload
        if (url.pathname === window.location.pathname && url.hash && url.href.replace(url.hash, '') === window.location.href.replace(window.location.hash, '')) {
            return false;
        }
