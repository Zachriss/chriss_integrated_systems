...
<div class="container-fluid px-3 px-lg-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0"><i class="bi bi-table me-2"></i>All Sessions</h4>
        <a href="{{ route('admin.cashpoint.index') }}" class="btn btn-primary">
            <i class="bi bi-arrow-left me-1"></i> Staff Overview
        </a>
    </div>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <strong class="fs-4">{{ $todaySessions->count() }}</strong>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    <div class="text-muted small">Open Today</div>
                    <strong class="fs-4 text-success">{{ $openCount }}</strong>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <strong class="fs-4 text-secondary">{{ $closedCount }}</strong>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white">
            <h5 class="mb-0"><i class="bi bi-calendar-day me-2"></i>Today's Sessions</h5>
        </div>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-outline-primary view-session" data-session-id="{{ $s->id }}">
                                    <i class="bi bi-eye"></i> Details
                                </button>
                                @if($s->status === 'Closed')
                                <button class="btn btn-sm btn-outline-warning reopen-session" data-session-id="{{ $s->id }}">
                        ...
                        @empty
                        <tr><td colspan="7" class="text-center text-muted py-3">No sessions today.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr><td colspan="7" class="text-center text-muted py-3">No sessions found.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
