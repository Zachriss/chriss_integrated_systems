                    ...
                    <div class="profile-avatar-shell">
                        @if($user->profile_image)
                            <div class="profile-avatar-fallback" style="overflow:hidden;">
                                <img src="{{ asset('storage/' . $user->profile_image) }}" alt="{{ $user->full_name }}" style="width:100%;height:100%;object-fit:cover;">
                            </div>
                        @else
                    ...
                    <div class="modal-body pt-3">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                @if($user->profile_image)
                                    <div class="mt-2">
                                        <img src="{{ asset('storage/' . $user->profile_image) }}" alt="Current" style="height:64px;border-radius:12px;object-fit:cover;">
